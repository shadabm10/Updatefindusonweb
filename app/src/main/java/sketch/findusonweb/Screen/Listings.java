...
ListView listing;
    ...
    AdapterReviewAll adapterReview;
    TextView back_img;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefrence = new Shared_Preference(Listings.this);
        prefrence.loadPrefrence();
        pd = new ProgressDialog(Listings.this);
        ...
        if (globalClass.isNetworkAvailable()) {
            ...
            Toasty.info(Listings.this, getResources().getString(R.string.check_internet), Toast.LENGTH_LONG, true).show();
        }
        ReviewList();
            ...
            public void onResponse(String response)
            {
                ...
                try {
                    ...
                    if (result.equals("1")) {
                        ...
                        adapterReview = new AdapterReviewAll(Listings.this, list_namesfavoriteAll);
                        listing.setAdapter(adapterReview);
                    }
                    else
...

                    {
                        ...
                        Toasty.success(Listings.this, result, Toast.LENGTH_SHORT, true).show();
                    }
                    // favorite();

                } catch (Exception e) {

                    Toasty.warning(Listings.this, "NO DATA FOUND", Toast.LENGTH_SHORT, true).show();
                    e.printStackTrace();

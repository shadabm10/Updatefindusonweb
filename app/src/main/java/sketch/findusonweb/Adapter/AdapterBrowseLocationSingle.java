...
public class AdapterBrowseLocationSingle extends BaseAdapter {
    ...
    public AdapterBrowseLocationSingle(Context c, ArrayList<HashMap<String,String>> list_names) {
        mContext = c;
